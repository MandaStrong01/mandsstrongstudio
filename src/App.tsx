      ...
      <div style={{maxWidth:860,margin:"0 auto"}}>
        ...
        {tab==="disc"&&(
          <div>
            ...
            <div style={{background:"#14161A",border:"1px solid "+GOLDDIM,padding:"12px 16px",marginTop:8}}>
              <p style={{color:GOLDDIM,fontSize:11,margin:0,letterSpacing:0}}>— Amanda Woolley · Founder · MandaStrong Studio · March 2026 · mandsstrongmovie.bolt.host</p>
            </div>
          </div>
        )}
      </div>
...
export default function App() {
  ...
  const [showLanding,setShowLanding]=useState(()=>{try{return localStorage.getItem("ms_entered")!=="1";}catch{return true;}}); // landing screen -> Press to Create
  ...
  return (
    <div style={{background:"#1C1F25",minHeight:"100vh",fontFamily:"'Archivo',system-ui,sans-serif"}}>
      {showLanding&&<Landing onEnter={()=>{try{localStorage.setItem("ms_entered","1");}catch{}setShowLanding(false);}}/>}
